...
namespace frmLogin
{
    public partial class frmMenuPrincipal : Form
    {
        ...
        private void buscarAlumnoPorApellidoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            buscarAlumno.MdiParent = this;
            buscarAlumno.Show();
        }

        private void alumnosPorAulaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmAlumnosPorAula alumPorAula = new frmAlumnosPorAula();
            alumPorAula.MdiParent = this;
            alumPorAula.Show();
        }
        #endregion

        #region Hardcodeo de datos
